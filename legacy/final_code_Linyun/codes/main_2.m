...
xi_mean = zeros(50, 1);
xi_cov = rand(50);
eigen = randi([10, 20], 50, 1);
xi_cov = triu(xi_cov) + diag(eigen) + triu(xi_cov, 1)';
c_exp = rand(50, 1);
b_exp = 50 * rand(1);
alpha = 0.1;
...
result_SG3 = expSG(c_exp, b_exp, alpha, beta_exp, xi_mean, xi_cov, 150, 200, num_exp, sim_num);%new on Apr.22
