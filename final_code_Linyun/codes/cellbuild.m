function [out] = cellbuild(b, c, sigma, alpha, beta, sim_num, name1, name2, name3)
...
for i = 1:num_exp
    ...
    [sol_1(:, i), sol_2(:, i), sol_3(:, i), sol_4(:, i)] = phase2_1(data((n1+1):N, :),...
        sol_phase1{1, i}, b, c, alpha, beta, sim_num);
end
