"""Experiment: robust ellipsoidal chance constraint.

Compares the sectioning validator against the Gaussian-supremum validator and
baselines (dim == 5) for the RO-ellipsoid solver, sweeping the training/
validation split and the data size.

Run with:  python ro_ellipsoid.py
"""

import numpy as np
import pandas as pd

from gsv.formulations import CCP_RO_ellipsoid
...
for n in [100, 200, 300, 400, 500]:
    ...
    #     B = K
        ...
        result = run_experiment(CCP_RO_ellipsoid,c,N,d,n,alpha,beta,K,B,n1,n2,delta=delta,b=b,dim=dim)
